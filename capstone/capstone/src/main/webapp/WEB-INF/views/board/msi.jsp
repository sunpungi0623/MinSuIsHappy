    ...
    <body>
		...
		<div class="row d-flex justify-content-center">
            ...
            <div class="card" style="width: 33rem; border:1px solid black;">
                <img src="/resources/img/MSI_sword.jpg" alt="msi" height="300" width="500">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><h5>CPU : i7-11세대</h5></li>
                    <li class="list-group-item"><h5>메모리 : 8GB</h5></li>
                    <li class="list-group-item"><h5>GPU : RTX3050 Ti</h5></li>
                    <li class="list-group-item"><h5>화면 : 39.62cm(15.6인치)</h5></li>
                    <li class="list-group-item"><h5>무게 : 2.25kg</h5></li>
                </ul>
            </div>
