   ...
   <div class="contents">
      ...
      <div class="header">
         ...
         <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link" href="/notebookList" value="mypage">기자재 정보</a></li>
            <a class="nav-link" href="#" value="mypage">기자재 추가</a></li>
            <a class="nav-link" href="#" value="mypage">대여 정보 수정</a></li>
            </li>
         </ul>
         </nav>
            ...
            <c:forEach items="${objList}" var="objectVO" varStatus="status">
               <tr>
                  ...
                  <td><c:out value="${objectVO.status}" /></td>
                        ...
                        <td><c:out value="${objectVO.retnDate}" /></td>
